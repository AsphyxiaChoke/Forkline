...
- 前端框架第一阶段已拆分：`index.html` 现在按 `public/js/core.js`、`public/js/api.js`、`public/app.js`、`public/js/bootstrap.js` 的顺序加载；共享状态、DOM 引用、API 请求和启动流程已从旧大文件中拆出，并新增 `docs/ARCHITECTURE.md` 记录后续模块迁移边界。
