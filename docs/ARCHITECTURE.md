...
11. `js/features/context-menu-loader.js`
12. `js/features/commit-actions-loader.js`
13. `js/features/graph.js`
14. `js/panels/inspector.js`
15. `js/panels/sync.js`
16. `js/panels/inspector-panel-loader.js`
17. `js/features/recovery-policy.js`
18. `js/features/recovery-undo.js`
19. `js/features/file-editor-loader.js`
20. `js/features/diff-workbench-loader.js`
21. `js/features/file-tree.js`
22. `js/features/diff-renderer.js`
23. `js/features/worktree-refresh.js`
24. `js/features/repositories.js`
25. `js/features/git-actions-loader.js`
26. `js/app/layout-utils.js`
27. `js/app/events.js`
28. `app.js`
29. `js/bootstrap.js`
